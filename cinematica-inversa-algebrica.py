...
def calculate_theta1(x, y, l1, l2, theta2): 
    print('\n##### Θ1 #####')

    term1 = math.atan2(y, x)
    print('atan2 = (',y, ',',x, ') = ',term1)

    term2 = math.atan2((l2*math.sin(theta2)), (l1+(l2*math.cos(theta2))))
    print('atan2 = (',l2*math.sin(theta2), ',',l1+(l2*math.cos(theta2)), ') = ',term2)

    theta1 = term1 - term2
    print('Θ1 = ',term1,'-',term2,'= ',math.degrees(theta1))
    return theta1

def calculate_theta1_linha(x, y, l1, l2,theta2):
    print('\n##### Θ2 #####')
...
def calculate_theta2(x, y, l1, l2):
    ...
    cos_theta2 = term1_numerator / term2_denominator
    print('cos(Θ2) = ',term1_numerator, '/',term2_denominator, '= ',cos_theta2)

    sin_theta2 = math.sqrt(1-cos_theta2**2)
    print('sin(Θ2) = +- raiz(1 -',cos_theta2, '²' '= ',sin_theta2)
    
    theta2 = math.atan2(sin_theta2,cos_theta2)
    print('Θ2 = - atan2(',sin_theta2,',',cos_theta2,') = ',math.degrees(-theta2))
    return -theta2
...
theta1 = calculate_theta1(x3,y3,L1,L2,theta2)
theta1_linha = calculate_theta1_linha(x3,y3,L1,L2,theta2_linha)
